...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Colores personalizados para el negocio de billar
        billar: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(228,100%,74%,1) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189,100%,56%,1) 0px, transparent 50%), radial-gradient(at 80% 50%, hsla(355,100%,93%,1) 0px, transparent 50%)',
      ...
      boxShadow: {
        ...
        'colored': '0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
